...
: ${AMENT_CURRENT_PREFIX:="/home/amr/amr_ws/src/install/amr_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amr_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/amr_description/environment/path.sh"
